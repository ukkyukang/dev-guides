...
- [📖 본문](#본문)
  - [1. Docker Compose란?](#1-docker-compose란)
    - [1.1 왜 필요한가?](#11-왜-필요한가)
  - [2. `compose.yml` 구조](#2-composeyml-구조)
    - [2.1 주요 옵션 레퍼런스](#21-주요-옵션-레퍼런스)
  - [3. 서비스 간 네트워킹](#3-서비스-간-네트워킹)
  - [4. 볼륨과 데이터 관리](#4-볼륨과-데이터-관리)
    - [4.1 네임드 볼륨 (데이터 영속성)](#41-네임드-볼륨-데이터-영속성)
    - [4.2 바인드 마운트 (개발용 파일 동기화)](#42-바인드-마운트-개발용-파일-동기화)
  - [5. 헬스 체크](#5-헬스-체크)
  - [6. 환경별 설정 분리](#6-환경별-설정-분리)
    - [6.1 `compose.override.yml` (개발 설정 자동 병합)](#61-composeoverrideyml-개발-설정-자동-병합)
  - [7. 주요 명령어](#7-주요-명령어)
- [❓ 자주 묻는 질문 (FAQ)](#자주-묻는-질문-faq)
  - [Q1: `docker-compose.yml` vs `compose.yml` 어떤 것을 써야 하나요?](#q1-docker-composeyml-vs-composeyml-어떤-것을-써야-하나요)
  - [Q2: `depends_on`은 서비스가 "준비"될 때까지 기다리나요?](#q2-depends_on은-서비스가-준비될-때까지-기다리나요)
  - [Q3: `docker compose run`과 `docker compose exec`의 차이는?](#q3-docker-compose-run과-docker-compose-exec의-차이는)
  - [Q4: 환경 변수는 어디에 정의해야 하나요?](#q4-환경-변수는-어디에-정의해야-하나요)
  - [Q5: `restart: unless-stopped` vs `restart: always`의 차이는?](#q5-restart-unless-stopped-vs-restart-always의-차이는)
- [🏗️ 예제 프로젝트](#예제-프로젝트)
- [🔗 참고 자료](#참고-자료)
- [⏭️ 다음 강의](#다음-강의)
