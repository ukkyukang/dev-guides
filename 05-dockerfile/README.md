...
- [🎯 학습 목표](#학습-목표)
- [📖 본문](#본문)
  - [1. Dockerfile 기초](#1-dockerfile-기초)
    - [1.1 기본 구조](#11-기본-구조)
    - [1.2 주요 명령어 레퍼런스](#12-주요-명령어-레퍼런스)
    - [1.3 `CMD` vs `ENTRYPOINT`](#13-cmd-vs-entrypoint)
  - [2. 베이스 이미지 선택](#2-베이스-이미지-선택)
    - [2.1 Python 베이스 이미지 비교](#21-python-베이스-이미지-비교)
    - [2.2 Alpine 주의사항](#22-alpine-주의사항)
    - [2.3 uv 공식 이미지](#23-uv-공식-이미지)
  - [3. 레이어 캐싱 전략](#3-레이어-캐싱-전략)
    - [3.1 캐싱 규칙](#31-캐싱-규칙)
    - [3.2 ❌ 비효율적인 순서](#32-비효율적인-순서)
    - [3.3 ✅ 최적화된 순서](#33-최적화된-순서)
  - [4. 멀티스테이지 빌드](#4-멀티스테이지-빌드)
    - [4.1 기본 패턴](#41-기본-패턴)
  - [5. uv를 활용한 Python Docker 이미지 (권장 ✅)](#5-uv를-활용한-python-docker-이미지-권장)
    - [5.1 uv 공식 이미지 활용](#51-uv-공식-이미지-활용)
    - [5.2 멀티스테이지 + uv](#52-멀티스테이지-uv)
  - [6. `.dockerignore`](#6-dockerignore)
  - [7. 보안 모범 사례](#7-보안-모범-사례)
  - [8. 디버깅 팁](#8-디버깅-팁)
- [❓ 자주 묻는 질문 (FAQ)](#자주-묻는-질문-faq)
  - [Q1: `COPY . .` 에서 `.`은 무엇인가요?](#q1-copy-에서-은-무엇인가요)
  - [Q2: `RUN` 명령어를 왜 `&&`로 연결하나요?](#q2-run-명령어를-왜-로-연결하나요)
  - [Q3: `--mount=type=cache`는 무엇인가요?](#q3---mounttypecache는-무엇인가요)
  - [Q4: Alpine과 slim 중 어떤 것을 써야 하나요?](#q4-alpine과-slim-중-어떤-것을-써야-하나요)
  - [Q5: 이미지 빌드 시 `--no-cache-dir`를 왜 쓰나요?](#q5-이미지-빌드-시---no-cache-dir를-왜-쓰나요)
- [🏗️ 예제 프로젝트](#예제-프로젝트)
- [🔗 참고 자료](#참고-자료)
- [⏭️ 다음 강의](#다음-강의)
